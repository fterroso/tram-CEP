 ...
 */
public class PossibleItineraryListener implements UpdateListener{
    
    static Logger LOG = Logger.getLogger(PossibleItineraryListener.class);   
        
    @Override
    public void update(EventBean[] ebs, EventBean[] ebs1) {
        for(EventBean eb : ebs){
            PossibleItineraryEventPOJO pie = (PossibleItineraryEventPOJO) eb.getUnderlying();
            ItineraryProfile.insertNewItinerary(pie);           
//            LOG.debug(pie);
        }      
    }
}
